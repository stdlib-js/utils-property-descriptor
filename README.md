...
```javascript
propertyDescriptor = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-property-descriptor@v0.2.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/utils-property-descriptor/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/utils-property-descriptor/actions/workflows/test.yml?query=branch:v0.2.0
